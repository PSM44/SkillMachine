...
C:\01. GitHub\Skills\90.USECASE\01.NEW_PROJECT\USECASE.01.NEW_PROJECT.COMPILED.txt
...
3. Lee el prompt principal: PROMPT.NEW_PROJECT.txt (already included in the compiled file).
