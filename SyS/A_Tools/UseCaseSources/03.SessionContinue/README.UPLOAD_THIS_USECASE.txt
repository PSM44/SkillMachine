...
C:\01. GitHub\Skills\90.USECASE\03.SESSION_CONTINUE\USECASE.03.SESSION_CONTINUE.COMPILED.txt
...
3. Lee el prompt principal: PROMPT.SESSION_CONTINUE.txt (already included in the compiled file).
